...
export function Chooser() {
  ...
  return (
    <main className="relative flex min-h-dvh flex-col items-center justify-center overflow-x-hidden px-4 py-10 pb-[max(6rem,env(safe-area-inset-bottom))] sm:px-8 sm:pb-10">
      <AmbientBg />
